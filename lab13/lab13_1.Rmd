...
shinyApp(ui, server)
```
-inside render plot is ggplot
-input$x means you're selecting "bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g" for the x-axis
...
shinyApp(ui, server)
```
-selected is where the button starts out
